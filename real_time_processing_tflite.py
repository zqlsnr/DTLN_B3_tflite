...
#!/usr/bin/python3
#-*- coding: utf-8 -*-
@FileName: real_time_processing_tflite.py
...
# load models
interpreter_1 = tflite.Interpreter(model_path='saved_model/model_tflite/model_1.tflite')
interpreter_1.allocate_tensors()
interpreter_2 = tflite.Interpreter(model_path='saved_model/model_tflite/model_2.tflite')
